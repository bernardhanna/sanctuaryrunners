...
>
    <div class="flex flex-col items-center pt-5 pb-5 mx-auto w-full max-w-container max-lg:px-5">
        ...
        <div class="flex flex-wrap gap-10 justify-between items-center pb-4 w-full text-sm leading-none max-md:max-w-full">
            ...
            <?php if ($show_search): ?>
            <!-- Search -->
            <div class="flex self-stretch my-auto min-h-[60px] min-w-60 shadow-[0px_0px_20px_rgba(63,0,119,0.07)] w-[396px]">
                <div class="flex-1 text-gray-400 shrink basis-12 min-w-60">
                    <div class="flex-1 w-full">
                        <div class="flex flex-1 justify-between items-center px-4 py-3 bg-white rounded size-full">
                            <div class="flex flex-1 gap-2 items-center self-stretch my-auto w-full shrink basis-0 min-w-60">
                                ...
                                <input
                                    type="search"
                                    class="flex-1 self-stretch my-auto text-gray-400 bg-transparent border-none outline-none shrink basis-0"
                ...
                <button
                    type="button"
                    class="flex gap-2 justify-center items-center px-6 py-4 h-full font-bold whitespace-nowrap bg-yellow-300 rounded-none text-slate-800 max-md:px-5 btn w-fit hover:bg-yellow-400 focus:ring-yellow-300"
                    @click="filterPosts()"
                    aria-label="Search posts"
                >
                    Search
        ...
        <main class="flex flex-col mt-4 w-full max-md:max-w-full" role="main" aria-label="Blog posts">
            <div class="flex flex-wrap gap-6 items-start w-full min-h-[454px] max-md:max-w-full" id="posts-container">
                ...
                <?php if ($blog_query->have_posts()): ?>
                    <?php while ($blog_query->have_posts()): $blog_query->the_post(); ?>
                        ...
                        $reading_time = '12 mins'; // You can calculate this dynamically
                        ?>
                        ...
                        >
                            ...
                            <div class="flex overflow-hidden relative flex-col gap-2.5 items-start pt-6 pb-44 w-full text-xs font-bold text-sky-800 whitespace-nowrap aspect-[1.565] min-h-[232px] max-md:pb-24">
                                ...
                                <?php if ($primary_category): ?>
                                    <div class="flex overflow-hidden relative gap-1 items-center px-3 py-1 <?php echo $primary_category->slug === 'events' ? 'bg-yellow-300' : 'bg-sky-300'; ?> rounded-none">
                            ...
                            <div class="flex flex-col p-6 w-full text-sm text-sky-950 max-md:px-5">
                                <div class="flex gap-2 items-start self-start leading-none">
