                    ...
                    <?php foreach ($items as $i => $item) { ?>
                        ...
                        <li class="w-full mb-4 md:mb-0">
                            <div class="w-full md:grid md:grid-cols-[1fr_auto_1fr] md:gap-4 items-stretch">
                                ...
                                <!-- Center marker + line -->
                                <div class="hidden md:flex relative justify-center items-center py-6 md:flex-col md:justify-between md:py-0">
                                    <div
                                    ...
                                    <div class="hidden md:flex gap-3 items-center md:flex-col md:items-center md:gap-2">
                                        <span
                                            class="shrink-0 bg-[linear-gradient(90deg,_rgba(3,89,135,1)_0%,_rgba(4,122,185,1)_91%)] bg-center rounded-[62.5rem] w-[1.5rem] h-[1.5rem] z-[2]"
                                            aria-hidden="true"
                                        ></span>

                                        <?php if ($display_date !== '') { ?>
                                            <!-- DESKTOP date beside marker -->
                                            <time
                                                datetime="<?php echo esc_attr($event_date); ?>"
                                                class="hidden md:block break-words text-left text-[0.75rem] font-[700] leading-[1.125rem] font-['Public Sans'] uppercase"
                                                style="color: <?php echo esc_attr($date_text_color); ?>;"
                                            >
                                                <?php echo esc_html($display_date); ?>
                                            </time>
