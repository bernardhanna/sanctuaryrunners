...
>
    <div class="max-xl:px-5 mx-auto w-full max-w-container pt-[10rem] pb-16">
    
            <div class="grid grid-cols-1 gap-16 items-start md:grid-cols-2 max-md:gap-10">

                <!-- Content Column -->
                <div class="flex flex-col max-w-[480px] max-md:max-w-full">

                    <!-- Breadcrumb Navigation -->
                    <?php if (!empty($breadcrumbs)): ?>
                    <nav
                        class="mb-8 max-sm:mb-6"
                            ...
                            <?php foreach ($breadcrumbs as $index => $breadcrumb): ?>
                                <li class="flex gap-2 items-center">
                                    <?php if ($breadcrumb['is_current']): ?>
                                        <span
                                            class="font-medium <?php echo esc_attr($breadcrumb_current_class); ?>"
                                            aria-current="page"
                                        >
                                    ...
                                    <?php else: ?>
                                        <a
                                            ...
                                            class="font-medium rounded hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500"
                                            tabindex="0"
                                        >
                                            <?php echo esc_html($breadcrumb['title']); ?>
                                        </a>
                    ...
                    <div
                        class="text-lg leading-7 <?php echo esc_attr($content_color_class); ?> max-sm:text-base max-sm:leading-6 wp_editor"
                        role="region"
                        aria-labelledby="<?php echo esc_attr($section_id); ?>-heading"
                    >
